    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      >
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="/">
            <span class="sr-only">Minnano Engineer</span>
            <img class="h-8 w-auto sm:h-10" src="" alt="みんなのエンジニア" />
        ...
        <PopoverGroup as="nav" class="hidden space-x-3 md:flex">
          ...
          <a
            href="/"
            :class="[
              'text-base font-medium text-gray-900 hover:text-gray-500',
              route.name === 'index'
          ...
          <Popover class="relative px-4 py-2" v-slot="{ open }">
            <PopoverButton
              :class="[
                'group inline-flex items-center focus:outline-none bg-white text-base font-medium hover:text-gray-500',
                open
                  ? 'text-gray-500 rounded-md focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
                  : 'text-gray-900'
              ]"
            >
              <span>Provide</span>
